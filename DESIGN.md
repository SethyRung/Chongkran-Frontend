...
version: alpha
name: Chongkran
description: A recipe sharing platform — green primary, Geist type, mono details, and pixel-letter emphasis composed on top of Nuxt UI's zinc neutral surface.
colors:
  primary: "#90c628"
  primarySoft: "#a7d645"
  primaryDeep: "#507219"
...
- **Brand color** — `text-primary`, `bg-primary`, `ring-primary`,
  ...
  dark mode. With the project's primary scale this resolves to `#90c628`
  light / `#a7d645` dark. Use opacity utilities (`bg-primary/30`,
...
| 400  | `#a7d645` | `primarySoft` — dark-mode primary |
| 500  | `#90c628` | `primary` — brand accent          |
| 600  | `#69961a` | Active/pressed on tinted surfaces |
| 700  | `#507219` | `primaryDeep` — hover/CTA bg      |
| 800  | `#425b19` | Deep decorative                   |
| 900  | `#384d1a` | Near-text dark accents            |
| 950  | `#1c2a09` | Deepest tone                      |

- **Primary `#90c628` (Primary 500):** the only saturated hue on the
  ...
  words. Tinted lighter in dark mode (`primary-400: #a7d645`).
- **Primary Deep `#507219` (Primary 700):** hover and pressed states for
...
**Accessibility note.** `#90c628` itself does not meet WCAG AA (4.5:1)
...
`primaryDeep` (`#507219`, ~5.6:1) for the background and keep the label
white.
