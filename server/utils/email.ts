        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:12px;border:1px solid #e4e4e7;">
          <tr>
            <td style="padding:32px 40px 24px 40px;border-bottom:1px solid #f4f4f5;">
              <p style="margin:0;font-size:22px;font-weight:700;letter-spacing:-0.01em;">🍜 Chongkran</p>
              <p style="margin:6px 0 0 0;font-size:13px;color:#71717a;">Recipe sharing, made simple</p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding:20px 40px;border-top:1px solid #f4f4f5;text-align:center;">
              <p style="margin:0;font-size:12px;line-height:18px;color:#a1a1aa;">© ${new Date().getFullYear()} Chongkran</p>
            </td>
          </tr>
        </table>
      </td>
...
export function sendVerificationEmail(params: {
  ...
  void sendEmail({
    to,
    subject: "Verify your Chongkran email",
    html: renderTemplate({
      heading: "Verify your email address",
      greeting: greeting(name),
      body: "Welcome to Chongkran! Confirm your email to start sharing and discovering recipes from cooks around the world.",
      buttonText: "Verify email",
      url,
      note: "This link expires in 1 hour. If you didn't sign up, you can safely ignore this email.",
    }),
  });
}
...
export function sendPasswordResetEmail(params: {
  ...
  void sendEmail({
    to,
    subject: "Reset your Chongkran password",
    html: renderTemplate({
      heading: "Reset your password",
      greeting: greeting(name),
      body: "We received a request to reset the password for your Chongkran account. Click the button below to choose a new one.",
